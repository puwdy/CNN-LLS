...
class Sightline(object):
    ...
    def process(self, model_path):
        ...
        """
        import json
        from lls_cnnmodel.data_loader import scan_flux_sample
        from lls_cnnmodel.localize_model import predictions_ann as predictions_ann_c2
        from lls_cnnmodel.data_loader import compute_peaks, get_lam_data
        from lls_cnnmodel.absorption import add_abs_to_sightline
        from lls_cnnmodel.data_model.Prediction import Prediction
        # Fluxes
